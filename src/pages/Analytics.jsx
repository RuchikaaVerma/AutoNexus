...
// Custom tooltip style recharts ke liye
const CustomTooltip = ({ active, payload, label }) => {
  if (active && payload && payload.length) {
    return (
      <div className="bg-gray-800 border border-white/10
  ...
  return (
    <div className="pt-16 min-h-screen bg-gray-950 p-5">
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        ...
        <div className="bg-gray-900 border border-white/5 rounded-xl p-5">
          ...
          <div className="text-xs text-white/30 mt-2">
            8 critical · 6 warning · 10 routine
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        ...
        {/* LINE CHART — Brake Temp Trend */}
        <div className="bg-gray-900 border border-white/5 rounded-xl p-5">
          <h3 className="text-xs font-bold tracking-widest
                         text-white/40 uppercase mb-5">
            ...
            return (
              <div
                ...
                className="flex items-center gap-4 p-3
                           bg-gray-800 rounded-xl border-l-2"
